...
const Auth: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // FIX: The AuthError type was causing a TypeScript error, indicating the 'message'
      // property does not exist. Casting to the base 'Error' type is a safe alternative
      // as all Firebase errors extend it.
